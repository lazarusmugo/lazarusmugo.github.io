  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center min-h-screen font-sans ">
        ...
        <section id="about-me" className="w-full p-8 bg-custom-blue">
              ...
              <div className="flex flex-col lg:flex-row gap-4 lg:justify-between">
                <div className="flex flex-col items-start gap-4  text-sm lg:text-lg lg:w-[80%]">
                  <p className="text-white text-start ">
                    ...
                    solutions and enterprise apps with a focus on fast, elegant,
                    and accessible user experiences.
                  </p>

                  <p className="text-white  text-start">
                    Currently, I work at TAJJI LTD as the team lead for mobile
                    development. My role involves overseeing the development of
                    the Tajji Boma mobile application, ensuring that it provides
                    seamless and intuitive experiences for managing residential
                    and commercial properties.
                  </p>

                  <p className="text-white  text-start ">
                    Before becoming the mobile team lead, I started at TAJJI LTD
                    as a frontend engineering intern. During my internship, I
                    worked on developing the landing page and the Progressive
                    Web App (PWA) for Tajji Boma, using SvelteKit, Tailwind CSS,
                  ...
                  <p className="text-white  text-start ">
                    ...
                    helps businesses create effective marketing emails using AI.
                  </p>

                  <p className="text-white  text-start">
                    At Golden Heart Nursing, I served as a Frontend Developer. I
                    utilized JavaScript, Tailwind CSS, and TypeScript with
                    Svelte to build their website. The focus was on delivering a
                    highly responsive and user-friendly web application that
